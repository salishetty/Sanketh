...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func appInit() {
        ...
        if ( AppContext.categories == nil || AppContext.categories?.count == 0) {
            ...
            dataMgr.saveContent(101, contentName: "30 x 3 = Fewer Headaches", contentDescription: "", contentValue: "Research is showing that regular exercise can help reduce the frequency of headaches. Just start a new exercise plan slowly.", contentType: "", imagePath: "DemoImage", audioPath: "DemoAudio")
            dataMgr.saveContent(102, contentName: "App-propriate Help for Headaches", contentDescription: "", contentValue: "In our approach to dealing with headaches, we recommend taking breaks from screen time. And while we don’t want to sound hypocritical, there are times when your phone can actually help.", contentType: "", imagePath: "DemoImage", audioPath: "DemoAudio")
            dataMgr.saveContent(103, contentName: "Don’t Skip Breakfast", contentDescription: "", contentValue: "This is pretty straightforward. If you’re skipping breakfast regularly, you’re not alone -about 36% of teens skip breakfast.  How does breakfast impact my headaches? We’re glad you asked.", contentType: "", imagePath: "DemoImage", audioPath: "DemoAudio")
            dataMgr.saveContent(104, contentName: "Give Yourself A Break", contentDescription: "", contentValue: "We all have days where we have a lot to get done, whether it’s a big project for school or studying for tests. One key to getting a lot done is to take breaks.", contentType: "", imagePath: "DemoImage", audioPath: "DemoAudio")
            dataMgr.saveContent(105, contentName: "Knowledge is Power", contentDescription: "", contentValue: "You might be tired of hearing that your headaches could be linked to your period and hormone changes. We’re really sorry, but our research shows that for about 50% of women with migraines, their menstrual cycle plays a role, maybe because estrogen levels dip during menstruation.", contentType: "", imagePath: "DemoImage", audioPath: "DemoAudio")
            dataMgr.saveContent(106, contentName: "One Step at a Time", contentDescription: "", contentValue: "Deciding to get more exercise is one thing. Building a routine can be quite another. Start slow and get prepped.", contentType: "", imagePath: "DemoImage", audioPath: "DemoAudio")
            dataMgr.saveContent(107, contentName: "Pain Hits the Road", contentDescription: "", contentValue: "While headaches might feel like they're ruling (and even ruining) your life at times, you can take charge. Try meditation. Reducing stress=Fewer headaches.", contentType: "", imagePath: "DemoImage", audioPath: "DemoAudio")
            dataMgr.saveContent(108, contentName: "Screens Off", contentDescription: "", contentValue: "More and more  teens are falling asleep with TV or other electronic equipment going on in the background. Maybe you think that having a TV show playing quietly will distract your busy mind, but study after study shows just the opposite.", contentType: "", imagePath: "DemoImage", audioPath: "DemoAudio")
            dataMgr.saveContent(109, contentName: "Scents-able Sleep", contentDescription: "", contentValue: "Ever have one of those nights when you’re studying hard for a test and then try to go right to sleep because it’s so late? Or maybe your brain just tends to spin away at bedtime most nights. Help yourself wind down with an essential oil like lavender.", contentType: "", imagePath: "DemoImage", audioPath: "DemoAudio")
            dataMgr.saveContent(110, contentName: "Sink or Swim?", contentDescription: "", contentValue: "Guided imagery gives you the chance to use your  imagination to help you relax. It can be a really powerful tool in reducing stress and anxiety. It’s also a distraction from pain.", contentType: "", imagePath: "DemoImage", audioPath: "DemoAudio")
            dataMgr.saveContent(111, contentName: "Sleeping in the Dark", contentDescription: "", contentValue: "Sleeping in a dark room sounds pretty obvious. But before you go to bed tonight, turn out the light and look around your room.", contentType: "", imagePath: "DemoImage", audioPath: "DemoAudio")
            dataMgr.saveContent(112, contentName: "Sleep Journal", contentDescription: "", contentValue: "School starts early. You might feel like a night owl. But getting consistent rest can help cut down the number of headaches you get. ", contentType: "", imagePath: "DemoImage", audioPath: "DemoAudio")
            dataMgr.saveContent(113, contentName: "Spike Your Water", contentDescription: "", contentValue: "Adding fresh herbs is a great way to give your water a burst of flavor. Check out our suggestions for a tasty way to boost the health benefits of hydration. Keep a nice, cool pitcher of water in the fridge or add herbs to your water bottle.", contentType: "", imagePath: "DemoImage", audioPath: "DemoAudio")
            dataMgr.saveContent(114, contentName: "Time and Timer Again", contentDescription: "", contentValue: "Here’s another good way to break up big projects and not go crazy in the process. Use a timer.", contentType: "", imagePath: "DemoImage", audioPath: "DemoAudio")
            dataMgr.saveContent(115, contentName: "Update Your Water (H20 2.0)", contentDescription: "", contentValue: "Water is…well, it’s pretty plain. It’s good for you, but that doesn’t make it exciting. Try some of these suggestions to give your H20 a boost.", contentType: "", imagePath: "DemoImage", audioPath: "DemoAudio")
