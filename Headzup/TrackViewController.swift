...
class TrackViewController: UIViewController {
    ...
    /*
    // MARK: - Navigation
    @@ -35,3 +56,237 @@ class TrackViewController: UIViewController {
    */
...
extension TrackViewController: CVCalendarViewDelegate, CVCalendarMenuViewDelegate {
...
extension TrackViewController {
    ...
    func supplementaryView(viewOnDayView dayView: DayView) -> UIView {
        ...
        let ringSpacing: CGFloat = 3.0 //3
        let ringInsetWidth: CGFloat = 3.0 //1.0
        let ringVerticalOffset: CGFloat = 2.0 //1.0
...
extension TrackViewController: CVCalendarViewAppearanceDelegate {
